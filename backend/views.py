...
def blog25(request):
    return(render(request,"blog25.html"))
def blog26(request):
    return(render(request,"blog26.html"))
def blog27(request):
    return(render(request,"blog27.html"))
def blog28(request):
...
def blog31(request):
    return(render(request,"blog31.html"))
def blog32(request):
    return(render(request,"blog32.html"))
def blog33(request):
    return(render(request,"blog33.html"))
def blog34(request):
    return(render(request,"blog34.html"))
